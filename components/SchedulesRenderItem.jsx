...
const SchedulesRenderItem = ({ item }) => (
  <View
    className="flex-col mt-2 p-3  bg-white rounded-xl shadow-xl shadow-gray-400 "
  >
    <TouchableOpacity className="flex-row items-center  gap-3 relative ">
      ...
      <View>
        <Text className="text-[19px] font-bold text-gray-700">{item.name}</Text>
    ...
    <View className="p-3">
      ...
      <View className="flex-row mt-2 w-full">
        <Pressable className="bg-gray-200 px-4 py-2 rounded-full w-50 min-w-[100px]">
          <Text className="text-red-800 font-semibold w-full text-center ">
            Delete
          </Text>
        </Pressable>
        <Pressable className="bg-[#2389DA] min-w-[100px] px-4 py-2 ml-2 rounded-full w-50">
