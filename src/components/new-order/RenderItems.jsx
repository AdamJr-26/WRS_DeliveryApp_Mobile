...
const RenderItems = ({ item }) => {
  return (
    <View
      className="mt-2 py-2 flex-col border-[1px] border-gray-300 rounded-xl "
    >
      <View className="p-2 flex-row items-center justify-between">
        <View className="flex-row">
          ...
          <View className="ml-2">
            <Text className="font-bold text-gray-600 ">Imperial Gallon</Text>
        ...
        <View>
          ...
          <TextInput
            placeholder="0"
            className="text-[16px] font-bold text-red-500 flex-col items-center justify-center text-center border-b-[1px] border-b-gray-300"
